#pragma checksum "C:\MVC-JQuery\WorkOrderTracking\Views\CustomerOrder\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "45a55e66657df713b5d9f358d1175d719acf5419"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"45a55e66657df713b5d9f358d1175d719acf5419", @"/Views/CustomerOrder/Index.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "45a55e66657df713b5d9f358d1175d719acf54193665", async() => {
        ...
        $(document).ready(function () {
            ...
            var table = $('#customerOrdersTable').DataTable({
                ...
                WriteLiteral(@"ent(row.orderDueDate).format('DD MMM, YYYY');
                    ...
                    {
                        ""data"": null, ""defaultContent"": ""<button id='btnCOEdit' class='btn btn-success'>Edit</button><span>|</span><button id='btnCODelete' class='btn btn-danger'>Delete</button>""
                    },
                ],
            });
            ...
            PlaceHolderElement.on('click', '[data-save=""modal""]', function (event) {
                ...
                $.post(actionUrl, sendData).done(function (response) {
                    ...
                    else if (response.result.s");
                WriteLiteral(@"tatusCode == 1) {
                        // model error
