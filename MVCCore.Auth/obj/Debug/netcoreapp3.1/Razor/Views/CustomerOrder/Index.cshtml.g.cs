#pragma checksum "C:\MVC-JQuery\MVCCore.Auth\Views\CustomerOrder\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a79370b1ec64e876fb423d5daa241c337d1722e5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a79370b1ec64e876fb423d5daa241c337d1722e5", @"/Views/CustomerOrder/Index.cshtml")]
...
<div>
    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a79370b1ec64e876fb423d5daa241c337d1722e53883", async() => {
...
");
    ...
    <script type=""text/javascript"">
        ...
        $(document).ready(function () {
            ...
            $('#customerOrdersTable tbody').on('click', '[id*=btnCOProgress]', function () {
                ...
                // bar chart
                var barData = [[");
                WriteLiteral(@"10, -20, 125, 230, -25, 245, 260, 20, 125, 125, 305, 110], [150, -50, 175, 280, -75, 295, 210, -70, 185, -20, 355, 160]];

                /* Horizontally accumulated Graph
                We set labels for X axis instead of numerical values
                You can see problems with different sign bar values at AUG and OCT
                */
  ...
  ");
                WriteLiteral(@"                  PlaceHolderElement.find('.modal').modal('show');
                });
                */
            });
    ...
    ");
            ...
            function bkTimer(result) {
                ...
                if (result.statusCode == 0) {
                    ...
                    content += '<img src=""../Images/error.png"" style = ""width:50px;");
