#pragma checksum "C:\MVC-JQuery\MVCCore.Auth\Views\CustomerOrder\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a94ea6ae7d63da9f1695752b979a634d4c9edb0a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a94ea6ae7d63da9f1695752b979a634d4c9edb0a", @"/Views/CustomerOrder/Index.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a94ea6ae7d63da9f1695752b979a634d4c9edb0a3808", async() => {
...
");
        ...
        $(document).ready(function () {
            ...
            function DrawonLoad() {
                $(function () {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/CustomerOrder/GetPiechartJSON',
                        success: function (chartsdata) {
                            // Callback that creates and populates a data table,
                            // instantiates the pie chart, passes in the data and
         ");
                WriteLiteral(@"                   // draws it.
                            ...
                            data.addColumn('string', 'OperationNumber');
                            data.addColumn('number', 'QtyDone');

                            //Loop through each list data
                            for (var i = 0; i < Data.length; i++) {
                                data.addRow([Data[i].operationNumber, Data[i].qtyDone]);
                            }
                            ...
                            var chart = new google.visualization.BarChart(document.getEleme");
                WriteLiteral(@"ntById('chartdiv'));
   ...
   ");
                WriteLiteral(@"                 { ""data"": ""customerOrderId"" },
                    ...
                    {
                        ""data"": null, ""defaultContent"": ""<button id='btnCOEdit' class='btn btn-primary'><i class='fa fa-edit fa-lg' aria-hidden='true'></i></button><span>&nbsp;</span><button id='btnCODelete' class='btn btn-danger'><i class='fa fa-trash fa-lg'></i></button><span>&nbsp;</span><button id='btnCO");
                WriteLiteral(@"Progress' class='btn btn-success'><i class='fa fa-spinner fa-lg'></i> Order</button>""
                    },
                ],
            });
            ...
            $('#customerOrdersTable tbody').on('click', '[");
                WriteLiteral(@"id*=btnCOEdit]', function () {
                var data = table.row($(this).parents('tr')).data();
                console.log(data);
                var customerOrderId = data.customerOrderId;
                console.log(customerOrderId);
      ...
      ");
            ...
            PlaceHolderElement.on('click', '[data-save=""modal""]', function (event) {
                ...
                WriteLiteral(@"esponse.result.statusCode == -1) {
                        errorCode = -1;
                        bkTimer(response.result);
                        // resetUI();
                    }
