#pragma checksum "C:\MVC-JQuery\MVCCore.Auth\Views\WorkOrder\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5e4374ffab5eede7106ebed987fe2d59e986b77e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5e4374ffab5eede7106ebed987fe2d59e986b77e", @"/Views/WorkOrder/Index.cshtml")]
...
<div>
    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5e4374ffab5eede7106ebed987fe2d59e986b77e3972", async() => {
        ...
        $(document).ready(function () {
            ...
            var table = $('#workOrdersTable').DataTable({
             ...
             ");
                WriteLiteral(@"       {
                    ...
                    {
                        ""data"": ""workOrderEndDate"", render: function (data, type, row) {//data

                            if (row.workOrderEndDate == null) {
                                return 'N/A';
                            } else {
                                ret");
                WriteLiteral(@"urn moment(row.workOrderEndDate).format('DD MMM, YYYY');
                            }
                        }
                    },
                    {
            ...
            $('#workOrdersTable tbody').on('click', '[id*=btnCODetails]', function () {
                ...
                $.get(url).done(function (data) {
                    ...
                    PlaceHold");
                WriteLiteral(@"erElement.find('.modal').modal('show');
                });
            });
            ...
            PlaceHolderElement.on('click', '[data-save=""modal""]', function (event) {
                ...
                var ");
                WriteLiteral(@"sendData = form.serialize();
            ...
            $('#workOrdersTable tbody').on('click', '[id*=btnWODelete]', function () {
                ...
                $.get(url).done(function (data) {
                    // console.log(data);
               ");
                WriteLiteral(@"     PlaceHolderElement.html(data);
                    PlaceHolderElement.find('.modal').modal('show');
                });
            });
