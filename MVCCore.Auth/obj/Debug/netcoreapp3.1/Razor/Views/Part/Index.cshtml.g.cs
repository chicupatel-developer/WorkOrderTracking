#pragma checksum "C:\WorkOrder-Tracking-jQuery\MVCCore.Auth\Views\Part\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0afdd070b72b9b878ab9343386d60e494fd87c34"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0afdd070b72b9b878ab9343386d60e494fd87c34", @"/Views/Part/Index.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0afdd070b72b9b878ab9343386d60e494fd87c343791", async() => {
...
");
        ...
        $(document).ready(function () {
            ...
            var table = $('#partTable').DataTable({
                ...
                columns: [
                    ...
                    { ""data"": ""name"" },
                    { ""data"": ""desc"", ""width"": ""40%"" },                    {
                        ""data"": null, ""defaultContent"": ""<button id='btnPartEdit' class='btn btn-primary'><i class='fa fa-edit fa-lg' aria-hidden='true'></i></button><span>&nbsp;</span><button id='btnPartDelete' class='btn btn-danger'><i class='fa fa-trash fa-lg'></i></button>""
                    },
                ]
            });
            ...
            // edit
            // t");
                WriteLiteral(@"his will open modal and display data to modal window
         ...
         ");
                WriteLiteral(@"       var data = table.row($(this).parents('tr')).data();
                console.log(data);
                var partId = data.partId;
                console.log(partId);
            ...
            PlaceHolderElement.on('click', '[data-save=""modal""]', function (event) {
                ...
                $.post(actionUrl, sendData).done(function (response) {
                    ...
                    conso");
                WriteLiteral(@"le.log(response.result.message);
                    var mErrors = '';
            ...
            function bkTimer(result) {
                ...
                if (result.statusCode == 0) {
                    ...
                    content += '<img src=""../Images/error.png"" ");
    ...
    ");
                WriteLiteral("            }              \r\n            };\r\n            function resetUI() {\r\n                $(\'#Name\').val(\'\');\r\n                $(\'#Desc\').val(\'\');\r\n                $(\'#Qty\').val(\'\');\r\n            };\r\n        });\r\n    </script>\r\n\r\n\r\n");
#nullable restore
#line 183 "C:\WorkOrder-Tracking-jQuery\MVCCore.Auth\Views\Part\Index.cshtml"
